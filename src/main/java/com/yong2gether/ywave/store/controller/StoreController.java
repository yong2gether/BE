...
public class StoreController {
    ...
    @Operation(summary = "특정 가맹점에 대한 상세 조회 API", description = "가맹점 storeId를 입력하면 Google Places API를 이용하여 상세 정보들을 전부 불러오는 API입니다.")
    @GetMapping("/stores/{storeId}/details")
    public PlaceDetailsDto detailsByStore(@PathVariable Long storeId) {
        return placeDetailsService.getDetailsByStoreId(storeId);
    }
